...
class SysEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self._steps = 0
        #todo 假设一开始没有能量，且i时刻之前收集的能量只能在i+1时刻开始使用，能量不是立即收集到的
    ...
    def step(self, action):
        ...
        new_rest_energy = min(self.rest_energy - p_send * self.time_interval
                              + self.random_energy_arr[self._steps], self.MAX_ENERGY)
