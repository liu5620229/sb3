...
plt.plot(np.arange(0, x_show_length, 1), hasty_p1, label='hasty', color='blue', linestyle='--', linewidth=2)
plt.plot(np.arange(0, x_show_length, 1), ppo_p1_data, label='ppo', color='green', linestyle='--', linewidth=2)
