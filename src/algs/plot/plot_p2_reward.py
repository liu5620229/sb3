...
# 绘制曲线
plt.plot(np.arange(0, x_show_length, 1), hasty_p2, label='hasty', color='blue', linestyle='--', linewidth=2)
...
plt.ylabel('多个环境吞吐量的平均值(bits)', fontsize=12) # y轴标签
